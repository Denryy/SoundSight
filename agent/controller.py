"""
AgentController — orchestration layer of the SoundSight autonomous agent.
...
This is the component that makes SoundSight an *autonomous* agent:
...
logger = logging.getLogger("soundsight.agent")
logger.setLevel(logging.INFO)

# Own handler with a dedicated format; don't propagate to root or every agent
# decision would be logged twice once core.logging_config configures the root.
...
class AgentController:
    ...
    def build_subtitle_payload(
        ...
        if decision.include_in_avatar and synced_frame is not None:
            ...
            payload["avatar_pose"] = synced_frame.avatar_pose
