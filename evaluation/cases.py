"""
Test cases for SoundSight agent evaluation.
...
CASES: list[EvalCase] = [
    ...
    EvalCase(
        ...
        expect_avatar=True,
        expect_summary=True,  # 6 meaningful words + 3 keywords → score 0.47 ≥ 0.40
        baseline_subtitles=True,
        baseline_avatar=True,
        baseline_summary=True,
        category="informative",
        explanation=(
            "Short but keyword-dense phrase. Agent shows it in subtitles and "
            "avatar, and its importance score clears the 0.40 summary threshold, "
            "so it is also stored for summarisation."
        ),
    ),
    EvalCase(
